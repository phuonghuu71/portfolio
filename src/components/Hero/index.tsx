  ...
  return (
    <section className="w-full flex items-center flex-col mb-28">
      ...
      <div className="mb-4 flex items-center gap-x-2">
        <div ref={ref}>
          <Link
            href="https://www.facebook.com/huuphuong.24.12.2k/"
            target="_blank"
          >
            <svg
        ...
        <div ref={ref}>
          <Link
            href={"https://www.linkedin.com/in/pnhp24122000/"}
            target="_blank"
          >
            <svg
        ...
        <div ref={ref}>
          <Link href={"https://github.com/phuonghuu71"} target="_blank">
            <svg
      ...
      <div className="flex gap-x-2 items-center">
        ...
        >
          ...
          <Link
            href={"#contact"}
            className="bg-black hover:bg-white hover:text-black border transition-colors uppercase font-medium text-white px-4 py-2 rounded-md w-36"
          >
            Contact Me
          </Link>
        </div>
        ...
        >
          <Link
            href={"/CV.pdf"}
            download={"CV"}
            className="bg-white hover:text-white transition-colors hover:bg-black font-medium uppercase text-black border px-4 py-2 rounded-md w-36 text-center"
          >
            My CV
          </Link>
